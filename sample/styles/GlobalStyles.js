...
const GlobalStyles = createGlobalStyle`  :root {
  ...
  * {
    ...
    min-height: 100vh;
    overflow-x: hidden;
    /* Cursor will be controlled by CursorEffect component conditionally */
  }
  ...
  /* Hide default cursor on clickable elements only when custom cursor is active */
  body.custom-cursor-active a, 
  body.custom-cursor-active button, 
  body.custom-cursor-active input[type="submit"], 
  body.custom-cursor-active input[type="button"], 
  body.custom-cursor-active .hover-effect {
    cursor: none;
  }
  h1, h2, h3, h4, h5 {
