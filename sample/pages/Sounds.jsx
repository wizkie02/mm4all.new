...
const IconWind = () => (
  ...
  >
    ...
    <path d="M9.6 4.6A2 2 0 1112 8H2" />
    <path d="M14.6 20.6A2 2 0 1017 17H6" />
  </svg>
);
// Fire flames
const IconFire = () => (
...
const IconBirds = () => (
  ...
  >
    <path d="M16 7h.01" />
    <path d="M3.4 18H12a8 8 0 008-8V7a4 4 0 00-7.28-2.3L2 20" />
    <path d="M20 7l2 .5-2 .5" />
    <path d="M10 18v3" />
    <path d="M14 17.75V21" />
    <path d="M7 18a6 6 0 003.84-10.61" />
  </svg>
);
// Cricket insect body
const IconCrickets = () => (
...
const IconSingingBowl = () => (
  ...
  >
    ...
    <path d="M20 14c0-1.1-3.6-2-8-2s-8 .9-8 2" />
    <path d="M12 12v-4" />
    <path d="M8 7a4 4 0 018 0" />
    <circle cx="12" cy="6" r="1" />
    <path d="M7 12c-1-1-1-2 0-3m10 3c1-1 1-2 0-3" />
    <path d="M5 15c-1-1-1-2 0-3m14 3c1-1 1-2 0-3" />
  </svg>
);
// Sound waves for white noise
const IconWhiteNoise = () => (
  <svg
    viewBox="0 0 24 24"
    width={iconSize}
    height={iconSize}
...
const soundsData = [
  {
    ...
    title: "Rain",
    Icon: IconRain,
    audioSrc: "https://cdn.freesound.org/previews/399/399072_3710957-lq.mp3",
  },
  {
    id: "thunder",
    title: "Thunder",
    Icon: IconThunder,
    audioSrc: "https://cdn.freesound.org/previews/531/531873_1059037-lq.mp3",
  },
  {
    id: "waves",
    title: "Waves",
    Icon: IconWaves,
    audioSrc: "https://cdn.freesound.org/previews/156/156598_981371-lq.mp3",
  },
  {
    id: "wind",
    title: "Wind",
    Icon: IconWind,
    audioSrc: "https://cdn.freesound.org/previews/527/527281_942923-lq.mp3",
  },
  {
    id: "fire",
    title: "Fire",
    Icon: IconFire,
    audioSrc: "https://cdn.freesound.org/previews/729/729395_12863902-lq.mp3",
  },
  {
    id: "birds",
    title: "Birds",
    Icon: IconBirds,
    audioSrc: "https://cdn.freesound.org/previews/468/468449_3405405-lq.mp3",
  },
  {
    id: "crickets",
    title: "Crickets",
    Icon: IconCrickets,
    audioSrc: "https://cdn.freesound.org/previews/210/210540_985466-lq.mp3",
  },
  {
    id: "coffeeshop",
    title: "Coffee Shop",
    Icon: IconCoffeeShop,
    audioSrc: "https://cdn.freesound.org/previews/453/453074_3569783-lq.mp3",
  },
  {
    id: "singingbowl",
    title: "Singing Bowl",
    Icon: IconSingingBowl,
    audioSrc: "https://cdn.freesound.org/previews/169/169289_71257-lq.mp3",
  },
  {
    id: "whitenoise",
    title: "White Noise",
    Icon: IconWhiteNoise,
    audioSrc: "https://cdn.freesound.org/previews/249/249313_4056007-lq.mp3",
  },
];
const Sounds = () => {
    ...
    if (!audioRefs.current[soundId]) {
      ...
      if (sound) {
        ...
        audio.addEventListener("error", (e) => {
          console.warn(`Failed to load audio for ${soundId}:`, e);
        });
  ...
  const playAudio = (soundId) => {
    ...
    if (audio && audio.paused) {
      audio.play().catch((e) => {
        console.warn(`Failed to play audio for ${soundId}:`, e);
      });
    }
  };
  ...
  useEffect(() => {
    const anySoundPlaying = Object.entries(playingSounds).some(
  ...
  const toggleSound = useCallback(
    ...
    [volumes]
  ); // Dependency on volumes ensures playAudio checks current volume// Handle individual volume change
  ...
  const handleMasterPlayPause = useCallback(() => {
    ...
    Object.entries(playingSounds).forEach(([soundId, shouldBePlaying]) => {
      if (shouldBePlaying) {
        // Only affect sounds the user intended to play
        if (nextMasterState) {
          playAudio(soundId);
        } else {
          pauseAudio(soundId);
      ...
      <PageWrapper>
        ...
        <HeaderSection>
          ...
          >
            ...
            <GradientUnderline />
            <Description>
              Mix ambient sounds to wash away distraction. Adjust individual
              volumes to create your perfect soundscape.
            </Description>
          </motion.div>
        </HeaderSection>
            ...
            >
              ...
              <VolumeSliderWrapper>
                <IndividualVolumeSlider
                  ...
                  title={`${sound.title} Volume: ${Math.round(
                    volumes[sound.id] * 100
                  )}%`}
        ...
        <TipBox>
          ...
          <div>
            ...
            <TipText>
              Click icons to toggle sounds. Adjust sliders for volume. Use the
              large central button to play/pause all active sounds. Set a timer
              using the 'Timers' button.
            </TipText>
          </div>
        </TipBox>
        {/* Timer Modal */}
              ...
              >
                ...
                <TimerTypeSelector>
                  <TimerTypeButton
                    ...
                    onClick={() =>
                      setTimerSettings((prev) => ({ ...prev, type: "stop" }))
                    }
                  >
                    Stop playing after
                  </TimerTypeButton>
                  <TimerTypeButton
                    ...
                    onClick={() =>
                      setTimerSettings((prev) => ({ ...prev, type: "start" }))
                    }
                  >
                    Start playing after
                  </TimerTypeButton>
                ...
                <TimeInputArea>
                  <TimeInput
                    ...
                    onChange={(e) =>
                      handleTimerSettingChange("hours", e.target.value)
                    }
                    min="0"
                  />
                  <span>hours and</span>
                  <TimeInput
                    ...
                    onChange={(e) =>
                      handleTimerSettingChange("minutes", e.target.value)
                    }
                    min="0"
                    max="59"
                  />
                ...
                <ModalActions>
                  ...
                  <ModalButton primary onClick={startTimer}>
                    Start timer
                  </ModalButton>
                </ModalActions>
              </ModalContent>
...
const MasterPlayButton = styled.button`
  ...
  box-shadow: 0 5px 15px rgba(161, 155, 232, 0.4);
  &:hover {
...
const SoundControlCard = styled(motion.div)`
  ...
  background: ${(props) =>
    props.$isActive
      ? "rgba(var(--primary-color-rgb, 138, 43, 226), 0.25)"
  ...
  &:hover {
    background: ${(props) =>
      props.$isActive
        ? "rgba(var(--primary-color-rgb, 138, 43, 226), 0.35)"
...
const VolumeSliderWrapper = styled.div`
  ...
  align-items: center;
`;
const IndividualVolumeSlider = styled.input`
...
const TimerTypeButton = styled.button`
  ...
  padding: 0.7rem;
  border: 1px solid
    ${(props) => (props.active ? "var(--primary-color, #8a2be2)" : "#ddd")};
  ...
  &:hover:not(:disabled) {
    background: ${(props) =>
      props.active ? "var(--primary-color)" : "#f5f5f5"};
    border-color: ${(props) =>
      props.active ? "var(--primary-color)" : "#bbb"};
  }
  &:disabled {
    opacity: 0.4;
    cursor: not-allowed;
...
const ModalButton = styled.button`
  ...
  border-radius: 8px;
  border: 1px solid
    ${(props) => (props.primary ? "var(--primary-color, #8a2be2)" : "#ddd")};
  background: ${(props) =>
    props.primary ? "var(--primary-color, #8a2be2)" : "white"};
  ...
  &:hover {
    ...
    background: ${(props) =>
      props.primary ? "var(--primary-color, #8a2be2)" : "#f5f5f5"};
    border-color: ${(props) =>
      props.primary ? "var(--primary-color, #8a2be2)" : "#bbb"};
  }
`;
